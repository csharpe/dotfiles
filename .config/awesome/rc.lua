...
-- Left in here as a reminder should I need one ;)
...
awful.screen.connect_for_each_screen(function(s)
    -- Wallpaper
		-- Commented out by CJS - 2020-04-20 - to remove default wallpaper from being set 
		-- relying on nitrogen  
    -- set_wallpaper(s)
    ...
    s.mywibox = awful.wibar({ position = "top", screen = s, height = 32 })
		...
		local memWidget = lain.widget.mem({ settings = function ()
			widget:set_markup("Mem Used: " .. mem_now.used .. "MB ")
		end})	
...
globalkeys = gears.table.join(
		awful.key({ modkey, "Shift",	}, "t", function() mypopup = awful.popup {
			widget = wibox.widget {
            text   = os.getenv('EDITOR'),
